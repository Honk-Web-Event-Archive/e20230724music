...
!(function (e, t) {
  "object" == typeof exports && "object" == typeof module
    ...
    ? (exports.miHoYoBrowserTips = t())
    : (e.miHoYoBrowserTips = t());
  ...
  return (function (e) {
          ...
          return (
              ...
              if (
                ...
                (f.prefix =
                  ...
                  f.request(function (e) {
                    (f.config = f.getPrefixConfig(e)), f.render();
                  }),
                  console.error("browser error");
              }
            }),
            (e.prototype.render = function () {
              var e = u({ list: this.getBrowserList() }, this.config),
                t = document.createElement("div");
              (t.className =
                "mihoyo-browser-tips " +
                (r.IS_MOB ? "mihoyo-browser-tips--mobile" : "")),
            ...
            (e.prototype.getPrefixConfig = function (e) {
              var t = this,
                n = {};
              return (
                i.COMMON_CONFIG_KEY_MAPS.forEach(function (i) {
                  var o = t.prefix ? t.prefix + "_" + i : i,
                    s = e[o];
                  (0, r.isNotExtend)(s) ? (n[i] = "") : (n[i] = e[o] || e[i]);
                }),
                n
              );
            }),
            (e.prototype.formatInnerHTML = function (e) {
              ...
              return (
                l.forEach(function (e) {
                  f +=
                    '\n        <a class="mihoyo-browser-tips__item" href="' +
                    e.link +
                    '" target="_blank">\n          <img class="mihoyo-browser-tips__icon" src="' +
                    e.icon +
                    '" alt="">\n          <div class="mihoyo-browser-tips__btn" style="background: ' +
                    u +
                    "; color: " +
                    c +
                    '">\n            <span>' +
                ...
                '\n      <div class="mihoyo-browser-tips__main" style="background-image: url(\'' +
                  t +
                  '\')">\n        <img class="mihoyo-browser-tips__slogan" src="' +
                  n +
                  '" alt="">\n        <p class="mihoyo-browser-tips__title" style="color: ' +
                  r +
                  '">' +
                  o +
                  '</p>\n        <p class="mihoyo-browser-tips__desc" style="color: ' +
                  i +
                  '">' +
                  s +
                  '</p>\n        <div class="mihoyo-browser-tips__list">\n          ' +
                  f +
                  '\n        </div>\n        <img class="mihoyo-browser-tips__logo" src="' +
                  a +
                  '" alt="">\n      </div>\n    '
              );
            }),
            (e.prototype.getBrowserList = function () {
              var e = this;
              return this.config.show_browser
                ? c([], Array(i.BROWSER_ITEM_NUM), !0)
                    .map(function (t, n) {
                      return {
            ...
            (e.prototype.getJsonUrl = function () {
              return (
                "https://webstatic" +
                (this.isSea ? ".hoyoverse" : ".mihoyo") +
                ".com/admin/mi18n/" +
                (this.isSea ? "plat_oversea" : "plat_cn") +
                "/m10081518461181/m10081518461181-" +
                this.lang +
                ".json"
              );
            }),
            (e.prototype.request = function (e) {
              var t = new XMLHttpRequest(),
                n = this.getJsonUrl();
              if (!t) return new Error("Cannot create an XMLHTTP instance");
              (t.onreadystatechange = function () {
                if (t.readyState === XMLHttpRequest.DONE) {
                  if (200 !== t.status) throw new Error("ajax error");
            ...
            (e.prototype.getLang = function () {
              if (!this.isSea) return "zh-cn";
              var e = o.default.checkLang(
                r.QS.lang ||
                  s.default.get("mi18nLang") ||
                  o.default.getGameLang()
              );
              return (
                i.LANG_MAPS.filter(function (t) {
                  return t === e;
                })[0] || "en-us"
              );
            }),
    ...
    function (e, t, n) {
      ...
      var s = (t.isIE = !(
        ...
        u = ((t.QS = a()), (t.isMumu = o.default.mumu()));
      (t.BROWSER_LIST_CONFIG = { ie: s, mumu: u }),
      ...
      "undefined" != typeof self && self,
        (e.exports = (function (e) {
              ...
              var n = (function () {
                ...
                i = {
                  ...
                  isEmpty: function (e) {
                    var t = !0;
                    return (
                      e && "string" == typeof e && String(e).trim() && (t = !1),
                      t
                    );
                  },
          ...
          function (e, t, n) {
            ...
            (t.default = new i.default()), (t.MhyBrowser = i.default);
          },
        ]).default);
    },
    function (e, t, n) {
      ...
      (t.COMMON_CONFIG_KEY_MAPS = r(
        ...
        r([], Array(i), !0).reduce(function (e, t, n) {
          var i = [
            "browser" + (n + 1) + "_link",
            "browser" + (n + 1) + "_name",
            "browser" + (n + 1) + "_icon",
        ...
        t.default = {
          ...
          getGameLang: function () {
            ...
            return (
              t
                ? (c = t)
                : (i && (c = o.default[this.dealStr(i)])) ||
                  (c = this.getDefaultLang(a, u, r)),
              c
            );
          },
          getDefaultLang: function (e, t, n) {
            var r = void 0;
            if (t > -1) r = e.substr(t).trim().split("/")[3];
            else {
