...
!(function (t, e) {
  "object" == typeof exports && "object" == typeof module
    ...
    ? (exports.miHoYoEventLogin = e())
    : (t.miHoYoEventLogin = e());
})(window, function () {
  return (function (t) {
    var e = {};
    function n(r) {
    ...
    function (t, e, n) {
      ...
      t.exports = function (t, e, n, u) {
        if (t) {
          ...
          a(l, s) || o(l, s, { configurable: !0, value: e }),
            u && !r && i(l, "toString", c);
        }
      };
    },
    ...
    function (t, e, n) {
      ...
      t.exports = s(
        ...
        "Array",
        function (t, e) {
          f(this, { type: "Array Iterator", target: r(t), index: 0, kind: e });
        },
        function () {
          var t = p(this),
            e = t.target,
      ...
      if (
        (o("keys"), o("values"), o("entries"), !u && l && "values" !== d.name)
      )
        try {
    ...
    function (t, e, n) {
      ...
      function s(t) {
        ...
        return new Promise(function (n, i) {
          var a = !1,
            s = r({}, e, { data: r({}, e.data || {}) });
          "string" == typeof s && (s = { url: e });
          var u = s.url;
          u.indexOf("mi18n/") < 0
            ? ((u = c + s.url), "get" === t && (s.data.ts = Date.now()))
            : (a = !0),
            "get" === t
              ? (0, o.getJSON)(u, s.data, n, i, { withCredentials: !a })
              : "post" === t &&
                ((s.headers = r(
      ...
      e.default = function (t) {
        var e = t.environment,
          ...
          o = t.host,
          s = void 0 === o ? {} : o,
          u = n ? i.API_BASE_SEA[e] : i.API_BASE_CN[e],
          l = r({}, i.DEFAULT_HOST, s)[n ? "sea" : "cn"];
        c = (0, a.replaceHost)(u, l);
      };
    },
    function (t, e, n) {
      "use strict";
      ...
      (e.debounce = function (t, e, n) {
        ...
        return function () {
          ...
          r && clearTimeout(r);
          var u = function () {
              (r = null), n || (o = t.apply(s, a));
            },
            l = n && !r;
          return (r = setTimeout(u, e)), l && (o = t.apply(this, a)), o;
        };
      }),
    ...
    function (t, e, n) {
      ...
      n(60),
        (e.default = {
          components: { LoginModal: i.default },
          props: {
            environment: { type: String, required: !0 },
            resolve: { type: Function },
            reject: { type: Function },
            localText: { type: Object },
            gameBiz: { type: String, required: !0 },
      ...
      n(60),
        (e.default = {
          ...
          props: {
            ...
            onFail: { type: Function, default: function () {} },
            resolve: { type: Function },
            reject: { type: Function },
            localText: { type: Object, default: function () {} },
            gameBiz: { type: String, required: !0 },
            lang: { type: String, required: !0 },
            isMob: { type: Boolean },
            isSea: { type: Boolean },
                        ...
                        switch ((e.prev = e.next)) {
                          case 0:
                            return (
                              (n = {
                                url: "/region/list",
                                data: { game_biz: t.gameBiz, lang: t.lang },
                              }),
                              (e.next = 3),
                              (0, r.get)(n)
                            );
              ...
              this.region
                ? this.uid
                  ? this.level
                    ? this.code
                      ? this.checkCode()
                      : this.$toast(this.localText.placeholder4)
                    : this.$toast(this.localText.placeholder3)
                  : this.$toast(this.localText.placeholder2)
                : this.$toast(this.localText.placeholder1);
            },
            handleClose: function () {
    ...
    function (t, e, n) {
      ...
      e.default = {
        props: {
          ...
          isCaptcha: { type: Boolean, default: !1 },
          isSelect: { type: Boolean, default: !1 },
          placeholder: { type: String, default: "" },
          infos: { type: Object, default: function () {} },
          gameBiz: { type: String },
          lang: { type: String },
          localText: { type: Object, default: function () {} },
        },
        ...
        created: function () {
          (this.captchaText = this.localText && this.localText.btn3),
            (this.debounceSendCaptcha = (0, c.debounce)(
              this.sendCaptcha,
              500,
              !0
            ));
        ...
        methods: {
                    ...
                    for (;;)
                      switch ((e.prev = e.next)) {
                        ...
                        case 4:
                          ...
                          return (
                            t.$toast(t.localText.placeholder1),
                            e.abrupt("return")
                          );
                        case 7:
                          if (t.infos.uid) {
                          ...
                          return (
                            t.$toast(t.localText.placeholder2),
                            e.abrupt("return")
                          );
                        case 10:
                          if (t.infos.level) {
                          ...
                          return (
                            t.$toast(t.localText.placeholder3),
                            e.abrupt("return")
                          );
                        case 13:
                        ...
                        case 19:
                          (n = e.sent),
                            ...
                            0 === r
                              ? ((t.isSend = !0),
                                t.countdown(),
                                t.$eventLogin.confirm())
                              : (t.$toast(o), (t.isVerify = !1)),
                            t.$emit("sendCaptcha"),
                            (e.next = 29);
                          break;
                        case 26:
          ...
          countdown: function () {
            var t = this;
            (this.captchaText = this.localText.btn4.replace(
              "{x}",
              this.countDown
            )),
              (this.timer = setInterval(function () {
                ...
                (t.countDown -= 1),
                  (t.captchaText = t.localText.btn4.replace(
                    "{x}",
                    t.countDown
                  ));
              }, 1e3));
    ...
    function (t, e, n) {
      ...
      var r,
        ...
        i = (r = o) && r.__esModule ? r : { default: r };
      e.default = {
        components: { LoginInput: i.default },
        props: {
          options: {
            type: Array,
            default: function () {
    ...
    function (t, e, n) {
      "use strict";
      Object.defineProperty(e, "__esModule", { value: !0 });
      (e.DEFAULT_HOST = { cn: "mihoyo", sea: "hoyoverse" }),
        (e.API_BASE_CN = {
        ...
        (e.MI18N_BASE_SEA = {
          ...
          production: "admin/mi18n/",
        }),
        (e.MI18N_BIZ = {
          default: { cn: "plat_cn", sea: "plat_oversea" },
          hkrpg: { cn: "hkrpg_cn", sea: "hkrpg_global" },
        }),
    ...
    function (t, e, n) {
      ...
      var r = function () {
          ...
          return r(
            ...
            [
              r("div", { staticClass: "mhy-event-login-switch" }, [
                r("div", {
                  staticClass: "mhy-event-login-switch__tip",
                  domProps: { innerHTML: e._s(e.localText.switchTip) },
                }),
              ]),
              e._v(" "),
              r("div", { staticClass: "mhy-event-login-switch__group" }, [
                r("div", {
                  staticClass: "mhy-event-login-switch__radio",
                  domProps: { innerHTML: e._s(e.localText.btn2) },
                  on: {
                    click: function (t) {
                ...
                r("div", {
                  staticClass: "mhy-event-login-switch__radio",
                  domProps: { innerHTML: e._s(e.localText.btn1) },
                  on: {
                    click: function (t) {
    ...
    function (t, e, n) {
      ...
      var r = function () {
          ...
          return r(
            ...
            [
              r("div", { staticClass: "mhy-event-login-uid" }, [
                r("div", {
                  staticClass: "mhy-event-login-uid__tip",
                  domProps: { innerHTML: e._s(e.localText.loginTip) },
                }),
                e._v(" "),
                r(
                  "div",
                  ...
                  [
                    ...
                    r("login-input", {
                      attrs: {
                        ...
                        infos: { region: e.region, uid: e.uid, level: e.level },
                        isCaptcha: "",
                        type: "tel",
                        gameBiz: e.gameBiz,
                        lang: e.lang,
    ...
    function (t, e, n) {
      ...
      var r = function () {
          ...
          return r(
            ...
            {
              class:
                ((t = { "mhy-event-login--desktop": !e.isMob }),
                (t["mhy-event-login__" + e.theme] = !0),
                t),
              on: {
                close: function (t) {
            ...
            [
              r("div", { staticClass: "mhy-event-login-confirm" }, [
                r("div", {
                  staticClass: "mhy-event-login-confirm__tip",
                  domProps: { innerHTML: e._s(e.localText.codeToast) },
                }),
                e._v(" "),
                r("div", { staticClass: "mhy-event-login-confirm__group" }, [
                  r(
                    "div",
                    {
    ...
    function (t, e, n) {
      ...
      var r = function () {
          ...
          return r(
            ...
            [
              r("div", { staticClass: "mhy-event-login-prompt" }, [
                r("div", {
              ...
              e._v(" "),
              r("div", { staticClass: "mhy-event-login-prompt__group" }, [
                r("div", {
                  staticClass: "mhy-event-login-prompt__radio",
                  domProps: { innerHTML: e._s(e.localText.cancelBtn) },
                  on: { click: e.handleClose },
                }),
                e._v(" "),
                r("div", {
    ...
    function (t, e, n) {
      ...
      var r = function () {
          ...
          return n("transition", { attrs: { name: "fade" } }, [
            n("div", { staticClass: "mhy-event-login mhy-event-login-modal" }, [
              n(
                "div",
    ...
    function (t, e, n) {
      ...
      var r = function () {
          var t = this,
            e = t.$createElement,
            n = t._self._c || e;
          return n("div", { staticClass: "mhy-event-login-input" }, [
            n(
              "input",
              t._b(
                {
            ...
            t.isCaptcha
              ? n(
                  "div",
                  {
                    ...
                    on: { click: t.debounceSendCaptcha },
                  },
                  [t._v("\n    " + t._s(t.captchaText) + "\n  ")]
                )
              : t._e(),
      ...
      var r = function () {
          ...
          return n(
            "div",
            {
              ...
              class: { "mhy-event-login-select--opened": t.show },
            },
            [
              n(
                "div",
                {
                  ...
                  on: {
                    click: function (e) {
                      return (
                        e.stopPropagation(), t.doSelect.apply(null, arguments)
                      );
                    },
                  },
                },
                ...
                t._l(t.options, function (e, r) {
                  return n(
                    "div",
                    {
                      ...
                      class: {
                        "mhy-event-login-select__item--active":
                          e.region === t.value,
                      },
                      on: {
                        click: function (n) {
          ...
          (a = {
            670: function () {
              ...
              !(function (e) {
                ...
                (i.prototype = {
                  ...
                  (a.prototype = {
                    ...
                    _get_fallback_config: function () {
                      var t = this;
                      return c(t.type)
                        ? t.fallback_config[t.type]
                        : t.new_captcha
                        ? t.fallback_config.fullpage
                        : t.fallback_config.slide;
                    },
                    _extend: function (t) {
                      var e = this;
                      new i(t)._each(function (t, n) {
                ...
                (e.Geetest || n.getElementById("gt_lib")) &&
                  (f.slide = "loaded"),
                  (e.initGeetest = function (t, n) {
                    ...
                    t.https
                      ...
                      ("050cffef4ae57b5d5e529fea9540b0d1" !== t.gt &&
                        "3bd38408ae4af923ed36e13819b14d42" !== t.gt) ||
                        ((o.apiserver = "yumchina.geetest.com/"),
                        (o.api_server = "yumchina.geetest.com")),
                      t.gt && (e.GeeGT = t.gt),
                      t.challenge && (e.GeeChallenge = t.challenge),
                      s(t.getType) && o._extend(t.getType),
                      (function (t, n, o, i) {
                        if (s(o.getLib)) return o._extend(o.getLib), void i(o);
                        if (o.offline) i(o._get_fallback_config());
                        else {
                          var a =
                            "geetest_" +
                            (parseInt(1e4 * r.random()) + new Date().valueOf());
                          (e[a] = function (t) {
                            "success" == t.status
                              ? i(t.data)
                              : t.status
                          ...
                          "init" === a
                            ? ((f[r] = "loading"),
                              ...
                              p(
                                ...
                                null,
                                function (t) {
                                  if (t) (f[r] = "fail"), y("networkError", o);
                                  else {
                                    f[r] = "loaded";
                                    for (
                                      var e = l[r], n = 0, i = e.length;
                                      n < i;
                                      n += 1
                                    ) {
                                      var a = e[n];
            ...
            352: function (t, e, n) {
              ...
              e.default = {
                init: function (t) {
                  var e,
                    n = t.environment,
                    r = void 0 === n ? "production" : n,
                    o = t.isSea,
                    i = void 0 !== o && o,
                    a = t.isAws,
                    u = void 0 !== a && a;
                  (l = (i ? (0, s.default)(r) : (0, c.default)(r)).takumi),
                    i &&
                      u &&
                      ["production", "prerelease", "pre"].includes(r) &&
                      (l = "https://sg-public-api.".concat(
                        (e = window.location.host).includes("hoyoverse.com")
                          ? "hoyoverse"
                          : e.includes("mihoyo.com")
                          ? "mihoyo"
                          : e.includes("hoyolab.com")
                          ? "hoyolab"
                          : "hoyoverse",
                        ".com"
                      )),
                ...
                verify: function (t) {
                  ...
                  return new Promise(function (n, i) {
                    ...
                    (0, a.post)("/common/aigis/api/preCheck", d, {
                      baseURL: l,
                      headers: r(
                        { "x-rpc-app_id": c },
                        r(
    ...
    function (t, e, n) {
      ...
      var r = n(3),
        ...
        mt = function (t) {
          var e = _(t),
            n = c(it, this, e);
          return (
            !(this === X && d(ct, e) && !d(st, e)) &&
            (!(n || !d(this, e) || !d(ct, e) || (d(this, G) && this[G][e])) ||
              n)
          );
        },
        gt = function (t, e) {
          ...
          if (n !== X || !d(ct, r) || d(st, r)) {
            var o = nt(n, r);
            return (
              !o || !d(ct, r) || (d(n, G) && n[G][r]) || (o.enumerable = !0), o
            );
          }
        },
        bt = function (t) {
      ...
      (f ||
        (N(
          (Y = (K = function () {
            if (m(Y, this)) throw Z("Symbol is not a constructor");
            var t =
            ...
            return l && pt && dt(X, e, { configurable: !0, set: n }), yt(e, t);
          }).prototype),
          "toString",
          function () {
            return Q(this).tag;
        ...
        l &&
          ...
          u || N(X, "propertyIsEnumerable", mt, { unsafe: !0 }))),
      r({ global: !0, wrap: !0, forced: !f, sham: !f }, { Symbol: K }),
      V(A(ft), function (t) {
        z(t);
      }),
      r(
    ...
    function (t, e, n) {
      ...
      t.exports = function (t, e, n, a, y, v, S) {
        ...
        var O,
          ...
          k = !1,
          T = t.prototype,
          C = T[w] || T["@@iterator"] || (y && T[y]),
          M = (!x && C) || P(y),
          R = ("Array" == e && T.entries) || C;
        if (
          (R &&
            (O = u(R.call(new t()))) !== Object.prototype &&
            O.next &&
            (i || u(O) === b || (l ? l(O, b) : c(O[w]) || d(O, w, _)),
            f(O, E, !0, !0),
            i && (h[E] = _)),
          m &&
            "values" == y &&
          ...
          if (
            ...
            for (A in j) (x || k || !(A in T)) && d(T, A, j[A]);
          else r({ target: e, proto: !0, forced: x || k }, j);
        return (
          (i && !S) || T[w] === M || d(T, w, M, { name: y }), (h[e] = M), j
        );
      };
    },
    function (t, e, n) {
      ...
      (b && x) ||
        ...
        g
          ...
          : c.addEventListener &&
            ...
            "file:" !== r.protocol &&
            !p(C)
          ? ((o = C), c.addEventListener("message", T, !1))
          : (o =
              "onreadystatechange" in h("script")
                ? function (t) {
                    d.appendChild(h("script")).onreadystatechange =
                      function () {
      ...
      t.exports = {
        ...
        compact: function (t) {
          for (
            ...
            for (
              var o = e[r], a = o.obj[o.prop], c = Object.keys(a), s = 0;
              s < c.length;
              ++s
            ) {
              var u = c[s],
      ...
      t.exports = {
        ...
        compact: function (t) {
          for (
            ...
            for (
              var i = e[r], a = i.obj[i.prop], c = Object.keys(a), s = 0;
              s < c.length;
              ++s
            ) {
              var u = c[s],
      ...
      var s = {
        install: function (t, e) {
          ...
          if (
            ...
            (0, i.default)({ environment: n, isSea: a, host: u }),
            t)
          )
            c(t, e);
          else {
            var l = document.querySelector(
              '[src="https://webstatic.mihoyo.com/dora/lib/vue/2.6.11/vue.min.js"]'
            );
            if (l)
              ...
              (f.src =
                "https://webstatic.mihoyo.com/dora/lib/vue/2.6.11/vue.min.js"),
                (f.onload = function () {
                  c(window.Vue, e);
                }),
                (f.onerror = function () {
    ...
    function (t, e, n) {
      ...
      var r,
        ...
        a = ".".concat(
          ...
          i()(r).call(r, "hoyoverse.com")
            ? "hoyoverse"
            : i()(r).call(r, "mihoyo.com")
            ? "mihoyo"
            : i()(r).call(r, "hoyolab.com")
            ? "hoyolab"
            : "hoyoverse"),
          ".com"
        ),
        c = {
          ...
          community: {
            development: "https://testing-sg-public-api".concat(
              a,
              "/community"
            ),
      ...
      console.log("supportEnvionment", s),
        (e.default = function (t) {
          if (!i()(s).call(s, t))
            throw new Error(
              "env: ".concat(t, " not contain in supportEnvionment")
            );
          return {
    ...
    function (t, e, n) {
      n(3)({ target: "Array", stat: !0 }, { isArray: n(37) });
    },
    function (t, e, n) {
      var r = n(94),
        o = n(141),
    ...
    function (t, e, n) {
      var r = n(226);
      n(250), n(251), n(252), n(253), n(254), n(255), n(256), (t.exports = r);
    },
    function (t, e, n) {
      var r = n(227);
      t.exports = r;
    ...
    function (t, e, n) {
      ...
      t.exports = function (t) {
        ...
        var m,
          ...
          O = 0;
        if (!S || (this == y && s(S)))
          for (m = l(e), g = n ? new this(m) : y(m); m > O; O++)
            (_ = v ? h(e[O], O) : e[O]), f(g, O, _);
        else
          for (
            w = (x = p(e, S)).next, g = n ? new this() : [];
            !(b = i(w, x)).done;
            O++
          )
            (_ = v ? c(x, h, [b.value, O], !0) : b.value), f(g, O, _);
        return (g.length = O), g;
      };
    },
    function (t, e, n) {
      ...
      var r = n(0),
        ...
        u = function (t) {
          return function (e, n, r, u) {
            ...
            for (; t ? d >= 0 : p > d; d += y) d in f && (u = n(u, f[d], d, l));
            return u;
          };
        };
    ...
    function (t, e, n) {
      var r = n(3),
        ...
        b = function (t, e, n) {
          var r = p(n, e - 1),
            o = p(n, e + 1);
          return (f(m, t) && !f(g, o)) || (f(g, t) && !f(m, r))
            ? "\\u" + h(d(t, 0), 16)
            : t;
        },
        x = s(function () {
    ...
    function (t, e, n) {
      n(295), n(51), n(96), n(301), n(313), n(314), n(315), n(52);
      var r = n(7);
      t.exports = r.Promise;
    },
    function (t, e, n) {
      ...
      var r = n(3),
        ...
        w = function (t, e) {
          var n,
            ...
            o = i(_, this);
          c
            ? (n = c(new b(), o ? a(this) : _))
            : ((n = o ? this : u(_)), l(n, g, "Error")),
            void 0 !== e && l(n, "message", h(e)),
            m && l(n, "stack", p(n.stack, 1)),
            d(n, r);
          var s = [];
          return y(t, x, { that: s }), l(n, "errors", s), n;
        };
      c ? c(w, b) : s(w, b, { name: !0 });
    ...
    function (t, e, n) {
      ...
      var r,
        ...
        et = I(U, function () {
          ...
          return (
            ((n.constructor = {})[F] = r),
            !(tt = n.then(function () {}) instanceof r) || (!e && D && !Z)
          );
        }),
        nt =
          et ||
        ...
        ot = function (t, e) {
          ...
          try {
            c
              ? (a || (2 === e.rejection && ut(e), (e.rejection = 1)),
                !0 === c
                  ? (n = i)
            ...
            if (
              ...
              ((e = C(function () {
                L
                  ...
                  : at("unhandledrejection", n, r);
              })),
              (t.rejection = L || st(t) ? 2 : 1),
              e.error)
            )
              throw e.value;
          });
      ...
      c({ global: !0, wrap: !0, forced: et }, { Promise: V }),
        ...
        c(
          { target: U, stat: !0, forced: s || et },
          {
            resolve: function (t) {
              return E(s && this === i ? V : this, t);
            },
          }
        ),
        c(
    ...
    function (t, e, n) {
      ...
      var r = n(327),
        ...
        v = function t(e, n, i, a, c, l, p, d, v, m, g, b, x, w, _) {
          for (
            var S, O = e, j = _, A = 0, P = !1;
            void 0 !== (j = j.get(h)) && !P;

          ) {
            var E = j.get(e);
            if (((A += 1), void 0 !== E)) {
              if (E === A) throw new RangeError("Cyclic object value");
              P = !0;
            }
            void 0 === j.get(h) && (A = 0);
          }
          ...
          if (
            ...
            if (l) {
              ...
              if ("comma" === i && x) {
                for (
                  var T = u.call(String(O), ","), C = "", M = 0;
                  M < T.length;
                  ++M
                )
                  C +=
                    (0 === M ? "" : ",") + b(l(T[M], y.encoder, w, "value", g));
                return [b(k) + "=" + C];
              }
          ...
          for (var D = 0; D < R.length; ++D) {
            var L = R[D],
              B = "object" == typeof L && void 0 !== L.value ? L.value : O[L];
            if (!c || null !== B) {
              var F = s(O)
                ? "function" == typeof i
                  ? i(n, L)
              ...
              _.set(e, A);
              var U = r();
              U.set(h, _), f(I, t(B, F, i, a, c, l, p, d, v, m, g, b, x, w, U));
            }
          }
          return I;
        };
    ...
    function (t, e, n) {
      ...
      t.exports = function t(e, n, r, o) {
        ...
        if ("string" == typeof e)
          return (function t(e, n) {
            ...
            return P(
              e.replace(/(['\\])/g, "\\$1").replace(/[\x00-\x1f]/g, N),
              "single",
              n
            );
          })(e, c);
        ...
        if ((void 0 === r && (r = 0), r >= h && h > 0 && "object" == typeof e))
        ...
        function _(e, n, i) {
          if ((n && (o = o.slice()).push(n), i)) {
            var a = { depth: c.depth };
            return (
              M(c, "quoteStyle") && (a.quoteStyle = c.quoteStyle),
              t(e, a, r + 1, o)
            );
          }
          return t(e, c, r + 1, o);
        ...
        if (
          ...
          for (
            ...
            z += " " + H[q].name + "=" + P(E(H[q].value), "double", c);
          return (
            (z += ">"),
      ...
      function U(t, e) {
        ...
        if (n) {
          r.length = t.length;
          for (var o = 0; o < t.length; o++) r[o] = M(t, o) ? e(t[o], t) : "";
        }
        var i,
          a = "function" == typeof b ? b(t) : [];
        if (w) {
          i = {};
      ...
      var r = n(154),
        ...
        u = function (t, e, n, r) {
          if (t) {
            ...
            for (
              var f = 0;
              n.depth > 0 && null !== (c = a.exec(i)) && f < n.depth;
      ...
      console.log("supportEnvionment", u),
        (e.default = function (t) {
          ...
          return l && "mihoyo" !== l
            ...
            : { communtiy: e, takumi: n, login: r, communityOld: i };
        });
    },
    function (t, e, n) {
      var r = n(135);
                    ...
                    var t =
                      ...
                      o =
                        arguments.length > 3 && void 0 !== arguments[3]
                          ...
                          : a,
                      i = arguments[4];
                    h(r({ url: t, data: e, success: n, failure: o }, i));
                  }),
                  m = (e.post = function () {
                    var t =
                        arguments.length > 0 && void 0 !== arguments[0]
                    ...
                    h(
                      r(
                        { url: t, data: e, success: n, failure: o, method: l },
                        i
                      )
                    );
                  }),
        ...
        return (
          a
            ...
            .forEach(function (t) {
              var e = t.split(":");
              e.length > 1 &&
                (u[e[0].toLowerCase()] = e.slice(1).join(":").trim());
            }),
    ...
    function (t, e, n) {
      ...
      e.default = function (t, e) {
        ...
        return "" !== (a = r.stringify(s)) && (a = "?" + a), o + a + c;
      };
    },
    function (t, e, n) {
      "use strict";
        ...
        p = function t(e, n, o, i, a, s, l, p, d, y, h, v, m) {
          ...
          if (
            ("function" == typeof l
              ...
              : g instanceof Date
              ? (g = y(g))
              : "comma" === o && c(g) && (g = g.join(",")),
            null === g)
          ) {
            if (i) return s && !v ? s(n, f.encoder, m) : n;
            g = "";
          }
          if (
            "string" == typeof g ||
            ...
            return s
              ? [h(v ? n : s(n, f.encoder, m)) + "=" + h(s(g, f.encoder, m))]
              : [h(n) + "=" + h(String(g))];
          var b,
            x = [];
                    ...
                    for (n = 0; n < l.length; ++n)
                      if (n !== f) {
                        var d,
                          ...
                          m = -1 === v ? h.indexOf("=") : v + 1;
                        -1 === m
                          ? ((d = e.decoder(h, i.decoder, p)),
                            (y = e.strictNullHandling ? null : ""))
                          : ((d = e.decoder(h.slice(0, m), i.decoder, p)),
    ...
    function (t, e, n) {
      ...
      var r = (function () {
        function t(t, e, n, r) {
          if ("number" != typeof t)
            throw new TypeError(
              "statusCode must be a number but was " + typeof t
            );
          if (null === e) throw new TypeError("headers cannot be null");
          if ("object" != typeof e)
            throw new TypeError(
              "headers must be an object but was " + typeof e
            );
          this.statusCode = t;
          var o = {};
        ...
        return (
          ...
          (t.prototype.getBody = function (t) {
            ...
            return t && "string" != typeof this.body
                  ...
                  for (;;)
                    switch ((f.prev = f.next)) {
                      case 0:
                        ...
                        return (
                          console.error("请传入 gameBiz"), f.abrupt("return")
                        );
                      case 4:
                        if (d) {
                          f.next = 7;
                        ...
                        y || console.error("请传入 lang"),
                                        ...
                                        case 0:
                                          return (
                                            ...
                                            (o =
                                              ...
                                              r +
                                              e +
                                              "/m05302259261621/m05302259261621-" +
                                              (m ? j : "zh-cn") +
                                              ".json"),
                                            (t.next = 5),
                                            (0, s.get)({ url: o })
                          ...
                          (t.prototype.$eventLogin = {
                                          ...
                                          switch ((e.prev = e.next)) {
                                            ...
                                            case 3:
                                              (a = t.extend(o.default)),
                                                ...
                                                b &&
                                                  (b.$destroy(),
                                                  b.$el.parentElement.removeChild(
                                                    b.$el
                                                  ),
                                                  (b = null)),
                                                (b = c),
                            ...
                            show: function (e) {
                              ...
                              return new Promise(
                                ((n = p(
                                  regeneratorRuntime.mark(function n(a, c) {
                                    var s, u;
                                    return regeneratorRuntime.wrap(
                                      function (n) {
                                        for (;;)
                                          switch ((n.prev = n.next)) {
                                            ...
                                            case 3:
                                              (s = t.extend(i.default)),
                                                ...
                                                x &&
                                                  (x.$destroy(),
                                                  x.$el.parentElement.removeChild(
                                                    x.$el
                                                  ),
                                                  (x = null)),
                                                (x = u),
                            ...
                            getInfoByAuthkey: function () {
                              ...
                              return new Promise(function (e, n) {
                                (0, s.get)({
                                  url: "/login/authKey",
                                  data: r({}, l.QS, t, {
                                    authkey: encodeURIComponent(
                                      t.authkey || l.QS.authkey
                                    ),
                                    lang: j,
                                    game_biz: d,
                                  }),
                            ...
                            prompt: function (e) {
                              ...
                              return new Promise(
                                ((n = p(
                                  regeneratorRuntime.mark(function n(o, i) {
                                    var a, s;
                                    return regeneratorRuntime.wrap(
                                      function (n) {
                                        for (;;)
    ...
    function (t, e) {
      t.exports =
        "data:image/png;base64,";
    },
    function (t, e, n) {
      "use strict";
      n(163);
    ...
    function (t, e, n) {
            ...
            (this.bodyUsed = this.bodyUsed),
              ...
              t
                ? "string" == typeof t
                  ...
                  : T && URLSearchParams.prototype.isPrototypeOf(t)
                  ? (this._bodyText = t.toString())
                  : I && M && (e = t) && DataView.prototype.isPrototypeOf(e)
                  ? ((this._bodyArrayBuffer = q(t.buffer)),
                    (this._bodyInit = new Blob([this._bodyArrayBuffer])))
                  : I && (ArrayBuffer.prototype.isPrototypeOf(t) || D(t))
      ...
      function Y(t, e) {
        return new Promise(function (n, r) {
          ...
          (i.onload = function () {
            ...
            !e || "object" != typeof e.headers || e.headers instanceof U
      ...
      (Y.polyfill = !0),
        k.fetch ||
          ((k.fetch = Y), (k.Headers = U), (k.Request = J), (k.Response = Q));
      var Z = n(109);
      function tt(t, e) {
        var n = y()(t);
        if (_.a) {
          ...
          .then(function (n) {
            var r,
              ...
              p = (function (t) {
                ...
                ? t
                : v()((r = "".concat(f))).call(r, t);
            return "GET" === u.toUpperCase()
              ? fetch(
                  v()((o = "".concat(p))).call(
                    o,
                    e ? Object(Z.stringify)(e, { addQueryPrefix: !0 }) : ""
                  ),
                  c
                ).then(function (t) {
                  return t.json();
                })
              : fetch("".concat(p), et({ body: i(e, c.headers) }, c)).then(
                  function (t) {
                    return t.json();
                  }
                );
      ...
      var it = rt,
        ...
        ct = ot,
        st = function (t, e, n) {
          return ot(t, e, et({ method: "POST" }, n));
        },
        ut = function (t, e, n) {
          return ot(
            t,
